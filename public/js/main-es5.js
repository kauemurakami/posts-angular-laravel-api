...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.openDialog = function () {
        var _this = this;
        var dialogRef = this.dialog.open(_post_dialog_post_dialog_component__WEBPACK_IMPORTED_MODULE_3__["PostDialogComponent"], { width: '500px' });
...
var PostService = /** @class */ (function () {
        ...
        this.http.get("/api/").subscribe(function (posts) {
            ...
            try {
                for (var posts_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](posts), posts_1_1 = posts_1.next(); !posts_1_1.done; posts_1_1 = posts_1.next()) {
                    ...
                    _this.posts.push(//posts atributo da classe
    ...
    PostService.prototype.like = function (id) {
        ...
        this.http.get('/api/like/' + id)
            .subscribe(function (event) {
            var p = _this.posts.find(function (p) { return p.id == id; }); //p é um objeto post , verificando se nosso array de posts possui um post com o id recebid viaparametro
            p.likes = event.likes;
        });
    };
    PostService.prototype.apagar = function (id) {
        ...
        this.http.delete('/api/' + id)
            .subscribe(function (event) {
            var i = _this.posts.findIndex(function (p) { return p.id == id; }); // retorna o index do objeto post cuja p id é recebido via parametro
            if (i >= 0) {
